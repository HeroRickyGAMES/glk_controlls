...
class cadastrohiperlink extends StatefulWidget {
  const cadastrohiperlink({Key? key}) : super(key: key);

  @override
  State<cadastrohiperlink> createState() => _cadastrohiperlinkState();

}

class _cadastrohiperlinkState extends State<cadastrohiperlink> {
  String? tipos;
