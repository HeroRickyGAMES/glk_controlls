...
class PesquisaPlacaSaida extends StatefulWidget {
  ...
  PesquisaPlacaSaida(this.Porteiro, this.PreFillPesquisa, {Key? key}) : super(key: key);
                            ...
                            onPressed: kIsWeb == false ? (){
                              ...
                              Navigator.push(context,
                                  MaterialPageRoute(builder: (context){
                                    return CameraComum('Saída Colaborador Porteiros', widget.Porteiro, '');
                                  }));
                            }: null,
                                            ...
                                            child: Container(
                                                ...
                                                child: ElevatedButton(
                                                  onPressed: () async {
                                                    ...
                                                    Navigator.push(context,
                                                        MaterialPageRoute(builder: (context){
                                                          return SaidaPrestadorSaida(widget.Porteiro, urlImage, documents['PertenceA'], documents['TipoDeVeiculo'], documents['Empresa'], Telefone, vagaComum, vagaMoto, VagaDiretoria, documents['Marca'], documents['Modelo'], documents['cor'], documents['PlacaVeiculo'], PermitidosVeiculos, documents['id'], documents['idEmpresa'], documents['galpao'], documents['RG']);
                                                        }));
                                                  },
